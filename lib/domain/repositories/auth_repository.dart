...
abstract class AuthRepository {
  ...
  Future<Either<Failure, User>> register(String name, String email, String password, UserType type);
  ...
  Future<Either<Failure, User>> removeTurmaFromUser(String userId, String turmaId);
} 