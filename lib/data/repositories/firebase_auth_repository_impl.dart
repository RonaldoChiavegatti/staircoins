...
class FirebaseAuthRepositoryImpl implements AuthRepository {
  ...
  @override
  Future<Either<Failure, User>> register(String name, String email, String password, UserType type) async {
    if (await networkInfo.isConnected) {
      try {
  ...
  @override
  Future<Either<Failure, User>> updateStaircoins(String userId, int amount) async {
    if (await networkInfo.isConnected) {
      try {
  ...
  @override
  Future<Either<Failure, User>> addTurmaToUser(String userId, String turmaId) async {
    if (await networkInfo.isConnected) {
      try {
  ...
  @override
  Future<Either<Failure, User>> removeTurmaFromUser(String userId, String turmaId) async {
    if (await networkInfo.isConnected) {
      try {
        final updatedUser = await datasource.removeTurmaFromUser(userId, turmaId);
        return Right(updatedUser);
      } on ServerException catch (e) {
        return Left(ServerFailure(e.message));
      } catch (e) {
